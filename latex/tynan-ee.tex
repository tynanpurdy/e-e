...
\listoftables
\newpage
\lstinputlisting[language=python, caption=1st Order B\'ezier Curve]{../py/1stbezier.py}
\lstinputlisting[language=python, caption=2rd Order B\'ezier Curve]{../py/2ndbezier.py}
\lstinputlisting[language=python, caption=3rd Order B\'ezier Curve]{../py/3rdbezier.py}
